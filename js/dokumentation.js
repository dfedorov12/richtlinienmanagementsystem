  ...
  return [
    ...
    sec('einstellungen', 'Einstellungen', 'admin', `
      ...
      <ul style="${ol}">
        ...
        <li style="${li}"><b>Reiter-Berechtigungen (Lesen/Schreiben):</b> eigener Bereich in den Einstellungen (Umschalter oben). Eine Zeile je <b>Person</b> oder <b>Sicherheitsgruppe</b>, eine Spalte je Reiter: <b>–</b> kein Zugriff, <b>L</b> Lesen, <b>S</b> Schreiben. Zelle anklicken schaltet weiter, Zeile aufklappen zeigt alle Reiter mit Beschriftung. Suche und Reiter-Filter für den Überblick. <b>Additiv</b> zu den Standardrechten, Admins haben immer Zugriff; „Nur Lesen" = Reiter sichtbar, aber Anlegen/Bearbeiten gesperrt; „Schreiben" schließt Lesen ein. „Einstellungen" bleibt Admins vorbehalten.</li>
        <li style="${li}"><b>Freigabe an Sicherheitsgruppen:</b> statt jede Person einzeln einzutragen, kann eine <b>Entra-Sicherheitsgruppe</b> berechtigt werden – wer in der Gruppe ist, bekommt den Reiter automatisch. Gespeichert wird die Objekt-ID der Gruppe, ein Umbenennen ändert also nichts. Verschachtelte Gruppen zählen mit.</li>
      </ul>`,
