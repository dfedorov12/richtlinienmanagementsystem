  ...
  return [
    ...
    sec('verwalten', 'Regelwerke anlegen & verwalten', 'admin', `
      ...
      <ul style="${ol}">
        ...
        <li style="${li}"><b>Kategorie:</b> Die Auswahl kommt aus der <b>Governance-Struktur</b> – dieselbe Systematik, in der das Konzernregelwerk geführt wird. Wer dort eine Zeile umbenennt oder ergänzt, ändert damit die Auswahl im Editor. Ein alter Wert bleibt wählbar, bis er ersetzt wird.</li>
