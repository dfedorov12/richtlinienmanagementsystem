  ...
  return [
    ...
    sec('prozesse', 'Prozesse (BPMN 2.0)', 'admin', `
      ...
      <ul style="${ol}">
        ...
        <li style="${li}"><b>Die geführte Vorführung ist zugleich das Lernvideo:</b> Ihre Texte sprechen die <b>Zuschauer</b> an und lassen sich mitlesen – von der Begrüßung über Konzept, Prüfung, Mitbestimmung und Freigabe bis zu „Was das für Sie heißt". Was zu klicken ist, steht klein darunter im <b>Hinweis</b>. Bildschirm aufnehmen, frei dazu sprechen – fertig ist das Video.</li>
