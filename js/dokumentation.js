  ...
  return [
    sec('start', 'Erste Schritte', 'all', `
      <ul style="${ol}">
        ...
        <li style="${li}"><b>Was sichtbar ist, wird freigegeben:</b> Von sich aus sieht jede:r nur den Reiter <b>„Wissen"</b>. „Meine Regelwerke", „Anleitung", „Dokumentation", das KI-Dashboard und alle Verwaltungs-, Freigabe- und Auswertungs-Reiter erscheinen, sobald die Administration sie freigibt – je Person, Gruppe oder für eine ganze Gesellschaft (Einstellungen → Reiter-Berechtigungen).</li>
