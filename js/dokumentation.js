  ...
  return [
    ...
    sec('freigabe', 'Konformitätsprüfung & Freigabe', 'review', `
      ...
      <ul style="${ol}">
        ...
        <li style="${li}"><b>Wirklich ein Klick:</b> Die Anmeldung läuft im Hintergrund. Waren Sie in diesem Browser schon einmal angemeldet, sehen Sie direkt die Ergebnisseite; beim ersten Mal blitzt die Microsoft-Seite kurz auf – <b>ohne Kontoauswahl</b>, denn Ihre Mail nennt der Anmeldung bereits Ihr Konto. Dafür gehen die Entscheidungs-Mails <b>einzeln</b> raus statt als Sammelmail: Nur so gehört der Knopf wirklich Ihnen.</li>
    ...
    sec('prozesse', 'Prozesse (BPMN 2.0)', 'admin', `
      ...
      <p style="margin:0 0 8px;line-height:1.55">Die Prozesslandschaft in der abgestimmten Darstellung: <b>Führungsprozesse</b> oben, <b>Kernprozesse</b> als Pfeile in die Ergebnisse (Aufträge, Produkte, Einnahmen), <b>Unterstützungsprozesse</b> unten. Jede Kachel ist anklickbar.</p>
      ...
      <ul style="${ol}">
        ...
        <li style="${li}"><b>Beliebig viele Bereiche:</b> Die Landkarte zeichnet jedes Band als eigene Zeile mit farbiger Titelspalte – drei wie im Werk oder sechs wie im Konzern. Kernprozesse behalten ihre Pfeilform mit den Ergebnissen rechts.</li>
