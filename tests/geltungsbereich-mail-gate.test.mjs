...
actx.window=actx; actx.globalThis=actx; actx.jsArg ??= jsArg; actx.sichereUrl ??= sichereUrl; vm.createContext(actx);
...
sctx.window=sctx; sctx.globalThis=sctx; sctx.jsArg ??= jsArg; sctx.sichereUrl ??= sichereUrl; vm.createContext(sctx);
