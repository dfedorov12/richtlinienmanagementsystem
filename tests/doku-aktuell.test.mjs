...
const FEATURES = [
  ...
  { name: 'Vorführ-/Testmodus',      code: () => /function demoAktivieren/.test(read('js/demo.js')),    begriffe: ['Vorführ- und Testmodus', 'Outlook-Postfach', 'Selbsttest', 'Anhang und Fundstelle'] },
